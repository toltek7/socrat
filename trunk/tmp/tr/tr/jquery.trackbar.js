    ...
    init : function(hash) {
        try {
            ...
            this.jq.html('<table' + (this.width ? ' style="width:'+this.width+'px;"' : '') + 'class="trackbar" onSelectStart="return false;">\
                <tr>\
                    <td class="l"><div class="leftBlock"><span></span><span class="limit"></span><img class="leftBegun" ondragstart="return false;" src="./imgtrackbar/b_l.gif" width="5" height="17" alt="" /></div></td>\
                    <td class="centerBlock c"></td>\
                    <td class="r"><div class="rightBlock"><span></span><span class="limit"></span><img class="rightBegun" ondragstart="return false;" src="./imgtrackbar/b_r.gif" width="5" height="17" alt="" /></div></td>\
                </tr>\
